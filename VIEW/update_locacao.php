...
?>
            ...
            <body>
                ...
                <div class="cadastro">
                    ...
                    <br><br>
                    <form action="/Alltap/CONTROLLER/altera_locacao.php" method="post">
                    <div class="row">
                        <div class="col">
                            <input type="hidden" value="<?php echo $locacao['id_produto']?>" name="id_produto" id="id_produto">
                            <input type="hidden" value="<?php echo $locacao['id_locacao']?>" id="id_locacao" name="id_locacao">
                        ...
                        <div class="col">
                            <label style="color: greenyellow; font-size: 24px;" for="status_locacao">STATUS DA LOCAÇÃO</label>
                            <select style="width: 50%; font-size: 26px;" id="status_locacao" name="status_locacao" required>
                                <option value="<?php echo $locacao['status_locacao'] ?>">ATIVA</option>
