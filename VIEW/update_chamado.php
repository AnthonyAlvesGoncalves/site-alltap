...
<?php
        ...
        if (isset($_GET['id'])) {
            ...
            $query = "SELECT chamados.status_chamado, chamados.id_produto, chamados.id_usuario, chamados.data_abertura, produto.nome as produto, produto.cod_etiq, usuario.nome ,chamados.observacao,
        ...
        <!-------------------------------->
        <div class="cadastro">
            <form method="post" action="/Alltap/CONTROLLER/altera_chamado.php">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <br>
                        <input type="hidden" id="id_chamado" name="id_chamado" value="<?php echo $id_chamado ?>">
                        <label for="status_chamado">STATUS:</label>
                        <select id="status_chamado" name="status_chamado" required>
                            <option value="<?php echo $chamado['status_chamado']?>"><?php echo $chamado['status_chamado']?></option>
                    ...
                    <div class="col-sm-4">
                        ...
                        <option value="<?php echo $chamado['id_produto']?>"><?php echo $chamado['produto']?> || <?php echo $chamado['cod_etiq']?></option>
                        </select>
                    ...
                    <div class="col-sm-4">
                        ...
                        <option value="<?php echo $chamado['id_usuario']; ?>"><?php echo $chamado['nome']?></option>
                            <?php
                            ...
                            ?>
                                <option value="<?php echo $usuario['id_usuario']; ?>"><?php echo $usuario['nome']; ?> || <?php echo $usuario['nome_acesso'] ?></option>
                            <?php
                            }
                            ?>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <select style="pointer-events: none;" id="locado" name="locado" required>
                            <option  value="<?php echo $chamado['locado']?>"><?php echo $chamado['locado']?></option>
                        </select>
                        <br>
                    ...
                    <div class="col-sm-4">
                        ...
                        <select style="pointer-events: none;" id="urgencia" name="urgencia" required>
                            <option value="<?php echo $chamado['urgencia']?>"><?php echo $chamado['urgencia']?></option>
                        </select>
                        <br>
